@section('title', 'Fimac Atlantis | Créer une sous-catégorie')
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-5 box-col-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Créer une sous-catégorie</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="form theme-form">
            <form action="{{ route('sub_categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Nom de la sous-catégorie *" value="{{ old('name') }}" required>
                            @error('name')
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-end">
                            <button type="submit" class="btn btn-success me-3">Ajouter une sous-catégorie</button>
