@section('title', 'Fimac Atlantis | Liste des Appartements')
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-sm-5 box-col-4">
          <ol class="breadcrumb"> 
            ...
            <li class="breadcrumb-item">Appartements</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="card-header card-no-border">
            <div class="header-top">
              ...
              <div class="icon-dropdown setting-menu">
                <a href="{{ route('appartements.create') }}" class="btn">
                    ...
                    <tr> 
                      ...
                      <td>
                        <div class="d-flex justify-content-end">
                          <!-- Icône Modifier -->
                          <a href="{{ route('appartements.edit', $appartement->id) }}" class="btn btn-sm btn-info me-2" title="Modifier">
                          ...
                          <form action="{{ route('appartements.destroy', $appartement->id) }}" method="POST" class="d-inline">
                              @csrf
                              @method('DELETE')
                              <button type="submit" class="btn btn-sm btn-danger" title="Supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet appartement ?')">
