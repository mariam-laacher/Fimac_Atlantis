@section('title', 'Fimac Atlantis | Créer une catégorie')
            ...
            <div class="row"> 
                ...
                <div class="col-xl-3 col-sm-5 box-col-4">
                    <ol class="breadcrumb"> 
                        ...
                        <li class="breadcrumb-item">Créer une catégorie</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="row">
                      <div class="col">
                          <div class="mb-3">
                              ...
                              <textarea class="form-control" name="description" rows="3" placeholder="Entrez les détails de la catégorie">{{ old('description') }}</textarea>
                              @error('description')
                                  <div class="text-danger">{{ $message }}</div>
                              @enderror
                          </div>
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <div id="imagePreviewContainer" style="margin-top: 10px; display: none;">
                                <img id="imagePreview" src="#" alt="Aperçu de l'image" style="max-height: 200px; border: 1px solid #ddd; padding: 5px; display: block;">
                  ...
                  <div class="row">
                      <div class="col">
                          <div class="text-end">
                              <button type="submit" class="btn btn-success me-3">Ajouter une catégorie</button>
