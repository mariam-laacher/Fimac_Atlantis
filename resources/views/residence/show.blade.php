                            ...
                            <div class="property-grid-5 property-block rounded border transation-this bg-white hover-shadow">
                                ...
                                <div class="property_text p-3">
                                    ...
                                    <ul class="d-flex quantity font-fifteen justify-content-center align-items-center">
                                        <li title="Baths"><span><i class="fa-solid fa-shower"></i></span> {{ $apartment->sdb > 0 ? 'Oui' : 'Non' }}</li>
                                                <li title="Bathroom"><span><i class="fa-solid fa-toilet"></i></span> {{ $apartment->wc > 0 ? 'Oui' : 'Non' }}</li>                                                                                                
                                                <li title="Area"><span><i class="fa-solid fa-vector-square"></i></span> {{ $apartment->surface }} m²</li>
                                                <li title="Level">
                                                ...
                                                <li title="Kitchen"><span><i class="fa-solid fa-utensils"></i></span> {{ $apartment->cuisine > 0 ? 'Yes' : 'No' }}</li> 
                                    </ul>
                                    {{-- <div class="agent">
